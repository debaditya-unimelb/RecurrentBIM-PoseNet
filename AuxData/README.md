This page contains the Blender file with the textures required to generate Synthetic images. The model of render has to be changed to get different render types.
